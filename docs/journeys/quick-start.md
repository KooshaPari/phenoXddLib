...
<UserJourney
    :steps="[
        { title: 'Install', desc: 'Install phenotype-xdd-lib package' },
        { title: 'Configure', desc: 'Set up basic configuration' },
        { title: 'Run', desc: 'Execute first operation' }
    ]"
    :duration="5"
    :gif-src="'/gifs/phenotype-xdd-lib-quickstart.gif'"
/>
...
cargo add phenotype-xdd-lib
# or
npm install @phenotype-xdd-lib/core
```
